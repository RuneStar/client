...
class FloorOverlayDefinition : IdentityMapper.Class() {
    ...
    class texture : OrderMapper.InConstructor.Field(FloorOverlayDefinition::class, 1) {
    ...
    class rgb : OrderMapper.InConstructor.Field(FloorOverlayDefinition::class, 0) {
        override val predicate = predicateOf<Instruction2> { it.opcode == PUTFIELD }
    }

    class rgb2 : OrderMapper.InConstructor.Field(FloorOverlayDefinition::class, -1) {
        override val predicate = predicateOf<Instruction2> { it.opcode == PUTFIELD }
    }
