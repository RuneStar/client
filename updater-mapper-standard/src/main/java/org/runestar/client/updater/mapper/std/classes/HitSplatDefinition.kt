...
class HitSplatDefinition : IdentityMapper.Class() {
    ...
    class fontId : ConstructorPutField(HitSplatDefinition::class, 0, INT_TYPE)
    class transformVarbit : ConstructorPutField(HitSplatDefinition::class, 12, INT_TYPE)
    class transformVarp : ConstructorPutField(HitSplatDefinition::class, 13, INT_TYPE)
}