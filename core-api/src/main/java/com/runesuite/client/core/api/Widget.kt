...
import com.runesuite.client.core.raw.access.XWidget
import com.runesuite.client.core.raw.access.XWidgetNode
...
class Widget(override val accessor: XWidget) : Wrapper() {
    ...
    val children: List<com.runesuite.client.core.api.Widget> get() = accessor.children?.map { com.runesuite.client.core.api.Widget(it) } ?: emptyList()
    ...
    operator fun get(childId: Int) : com.runesuite.client.core.api.Widget? = accessor.children?.get(childId)?.let { com.runesuite.client.core.api.Widget(it) }

    val group get() = com.runesuite.client.core.api.WidgetGroup(accessor.id shr 16)

    val id get() = accessor.id and 0xFFFF

    val parent: com.runesuite.client.core.api.Widget? get() {
        ...
        return com.runesuite.client.core.api.Widget(Client.accessor.widgets[pId shr 16]!![pId and 0xFFFF])
    }
