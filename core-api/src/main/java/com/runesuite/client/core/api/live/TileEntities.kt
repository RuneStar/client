...
abstract class TileEntities<T> {
    ...
    abstract protected fun fromTile(sceneTile: com.runesuite.client.core.api.SceneTile, xTile: XTile?): T

    open fun getAt(sceneTile: com.runesuite.client.core.api.SceneTile): T {
    ...
    fun getOnPlane(plane: Int): List<List<T>> {
        ...
        for (x in 0 until Scene.SIZE) {
            ...
            for (y in 0 until Scene.SIZE) {
                val tile = com.runesuite.client.core.api.SceneTile(x, y, plane)
