...
import com.runesuite.client.core.raw.access.XModel
import java.awt.Polygon

class Model(
        val base: com.runesuite.client.core.api.Position,
    ...
    private fun rotateTo(orientation: com.runesuite.client.core.api.Angle) {
    ...
    fun getTriangles(): List<List<com.runesuite.client.core.api.Position>> {
        val list = ArrayList<List<com.runesuite.client.core.api.Position>>(model.indicesX.size)
