...
interface Movement {
    ...
    object Walking: Movement {

        const val ALL = CollisionFlag.WALK_OBJECT or CollisionFlag.WALK_GROUND
        const val N = ALL or CollisionFlag.WALK_NORTH
        const val E = ALL or CollisionFlag.WALK_EAST
        const val S = ALL or CollisionFlag.WALK_SOUTH
        const val W = ALL or CollisionFlag.WALK_WEST
        const val NE = ALL or CollisionFlag.WALK_NORTH or CollisionFlag.WALK_NORTHEAST or CollisionFlag.WALK_EAST
        const val SE = ALL or CollisionFlag.WALK_SOUTH or CollisionFlag.WALK_SOUTHEAST or CollisionFlag.WALK_EAST
        const val SW = ALL or CollisionFlag.WALK_SOUTH or CollisionFlag.WALK_SOUTHWEST or CollisionFlag.WALK_WEST
        const val NW = ALL or CollisionFlag.WALK_NORTH or CollisionFlag.WALK_NORTHWEST or CollisionFlag.WALK_WEST
