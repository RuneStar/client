...
import com.runesuite.client.api.Position
...
interface Projection {
    ...
    open class Minimap(val minimap: com.runesuite.client.api.live.Minimap) : Projection {
        ...
        object Live : Minimap(com.runesuite.client.api.live.Minimap.Live)
    }

    open class Viewport(val camera: Camera, val viewport: com.runesuite.client.api.live.Viewport, val scene: Scene) : Projection {
        ...
        object Live : Viewport(Camera.Live, com.runesuite.client.api.live.Viewport.Live, Scene.Live)
    }
}